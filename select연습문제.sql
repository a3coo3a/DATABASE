...
select first_name||' '||last_name, job_id from employees where job_id in ('IT_PROG','SA_MAN'); -- 위와 동일
...
select first_name||' '||last_name, job_id from employees where job_id like '%MAN'; -- like 조건은 아래와 동일하게 출력되는 모습을 볼 수 있다
